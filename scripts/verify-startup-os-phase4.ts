...
const required=["src/lib/startup-os-phase4.ts","src/routes/app/revenue.tsx","src/startup-os-phase4.css","supabase/migrations/20260830130000_startup_os_phase4_revenue_operations.sql"];
...
console.log(`Startup OS Phase 4 release contract passed: ${tables.length} workspace-scoped revenue tables, 11 connected product surfaces, source-preserving intelligence/form ingestion, quote-to-invoice linkage and deterministic commercial calculations.`);
